...
namespace Craft.Net.Data
{
    public class ParticleEffect
    {
        ...
        public const string FireworksSpark = "fireworksSpark";
        public const string Bubble = "bubble";
        public const string Suspended = "suspended";
        public const string DeathSuspend = "deathsuspend";
        public const string TownAura = "townaura";
        public const string Crit = "crit";
        public const string MagicCrit = "magicCrit";
        public const string Smoke = "smoke";
        public const string MobSpell = "mobSpell";
        public const string MobSpellAmbient = "mobSpellAmbient";
        public const string Spell = "spell";
        public const string InstantSpell = "instantSpell";
        public const string WitchMagic = "witchMagic";
        public const string Note = "note";
        public const string Portal = "portal";
        public const string EnchantmentTable = "enchantmentTable";
        public const string Explode = "explode";
        public const string Flame = "flame";
        public const string Lava = "lava";
        public const string Footstep = "footstep";
        public const string Splash = "splash";
        public const string LargeSmoke = "largesmoke";
