...
* Craft.Net.Server: An implementation of the 12w49a Minecraft server protocol.
...
is simple. To get started, the following code will create a Minecraft 12w49a server:
