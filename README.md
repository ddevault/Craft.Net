...
Craft.Net currently supports Minecraft 1.6.1 on Windows, Linux and Mac.
...
* Full support for the 1.6.1 (version 72) Minecraft protocol
...
* Connect to and play on 1.6.1 multiplayer servers
